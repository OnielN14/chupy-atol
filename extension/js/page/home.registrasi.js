...
$('#form-foto-profil').change(function() {
    var imgPath = $(this)[0].value;
    var ext = imgPath.substring(imgPath.lastIndexOf('.') + 1).toLowerCase();
    if (ext == "png" || ext == "jpg" || ext == "jpeg") {
        $(this).removeClass('is-invalid')
        isFormFotoValid = true
    } else {
        $(this).addClass('is-invalid')
        isFormFotoValid = false
    }
    submitButtonBehaviour()
})
...
function submitButtonBehaviour() {
    ...
    if (isAggrementChecked && isFormNamaValid && isFormEmailValid && isFormAlamatValid && isFormPasswordSame && isFormTeleponValid && isFormPasswordValid && isFormTempatValid && isFormGenderValid && isFormTanggalValid && isFormFotoValid) {
